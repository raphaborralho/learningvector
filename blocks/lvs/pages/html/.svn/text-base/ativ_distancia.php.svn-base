...
$PAGE->requires->js('/blocks/lvs/pages/scripts/mascara.js',true);
...
// 		$table->head = array('Nome', 'Introdu&ccedil;&atilde;o', '%', 'Etapa', 'Exibir LV', 'A&ccedil;&otilde;es');
		$table->head = array('Nome', 'Introdu&ccedil;&atilde;o', '%', 'Etapa', 'Exibir LV');
	} else {
...
// 		$icons .= html_writer::empty_tag('a', array('class'=>'editing_update', 'title'=>$strupdate, 'href'=>"$path/mod.php?update=$forum->id&sesskey=".sesskey()));
// 		$icons .= html_writer::empty_tag('img', array('src'=> $OUTPUT->pix_url("/t/edit"), 'class'=>'iconsmall', 'alt'=>"$strupdate"));
// 		$icons .= html_writer::empty_tag('a', array('href'=>"$path/mod.php?delete=$forum->id&sesskey=".sesskey(), 'onclick'=>"return confirm('Deseja realmente excluir essa atividade ?');"));
...
// 		$icons = html_writer::empty_tag('span', array('class'=>'commands'));
// 		$icons .= html_writer::empty_tag('a', array('class'=>'editing_update', 'title'=>$strupdate, 'href'=>"$path/mod.php?update=$tarefa->id&sesskey=".sesskey()));
// 		$icons .= html_writer::empty_tag('img', array('src'=> $OUTPUT->pix_url("/t/edit"), 'class'=>'iconsmall', 'alt'=>"$strupdate"));
// 		$icons .= html_writer::empty_tag('a', array('href'=>"$path/mod.php?delete=$tarefa->id&sesskey=".sesskey(), 'onclick'=>"return confirm('Deseja realmente excluir essa atividade ?');"));
// 		$icons .= html_writer::empty_tag('img', array('src'=> $OUTPUT->pix_url("/t/delete"), 'class'=>'iconsmall', 'alt'=>"$strdelete"));
...
// 		$icons = html_writer::empty_tag('span', array('class'=>'commands'));
// 		$icons .= html_writer::empty_tag('a', array('class'=>'editing_update', 'title'=>$strupdate, 'href'=>"$path/mod.php?update=$wiki->id&sesskey=".sesskey()));
// 		$icons .= html_writer::empty_tag('img', array('src'=> $OUTPUT->pix_url("/t/edit"), 'class'=>'iconsmall', 'alt'=>"$strupdate"));
// 		$icons .= html_writer::empty_tag('a', array('href'=>"$path/mod.php?delete=$wiki->id&sesskey=".sesskey(), 'onclick'=>"return confirm('Deseja realmente excluir essa atividade ?');"));
// 		$icons .= html_writer::empty_tag('img', array('src'=> $OUTPUT->pix_url("/t/delete"), 'class'=>'iconsmall', 'alt'=>"$strdelete"));
